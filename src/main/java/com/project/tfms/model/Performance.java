...
public class Performance {
    ...
    private String reportType; // e.g., "Daily Fleet Summary", "Monthly Fuel Efficiency"

    @Lob // Use @Lob for large string data (e.g., JSON)
    @Column(nullable = false)
    private String data; // Stores the report data, typically as a JSON string
    ...
    // Constructor for creating new performance records
